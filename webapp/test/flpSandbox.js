		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "demo0010",
									"targetURL": "#aspndemodemo0010-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"aspndemodemo0010-display": {
								"semanticObject": "aspndemodemo0010",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=aspn.demo.demo0010",
									"url": sap.ui.require.toUrl("aspn/demo/demo0010")
								}
							}
						}
					}
